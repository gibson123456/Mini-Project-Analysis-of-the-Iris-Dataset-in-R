...
png("boxplot.png", width=800, height=800)  # save as image
par(mfrow = c(2,2))
...
boxplot(Petal.Width ~ Species, data = iris,
        ...
        col = c("lightblue","lightgreen","pink"))
dev.off()
Below is the Boxplot matrix generated by the above R code:
![Boxplot Matrix of Iris Features](boxplot.png)
